    ...
    <div
      ...
      className={`${
        isTableMode
          ...
          : 'fixed inset-0 z-50'
      } pointer-events-none flex items-center justify-center overflow-visible animate-in fade-in duration-100`}
    >
      ...
      {/* 1. Action Banner at Top (Compact, non-intrusive) */}
      <div
        className={`absolute ${
          isTableMode ? '-top-2 sm:-top-3' : 'top-14 sm:top-16'
        } z-50 flex flex-col items-center animate-in slide-in-from-top-3 duration-200 pointer-events-auto`}
      >
        <div className="bg-saloon-950/95 border border-amber-500/80 shadow-md shadow-amber-950/60 px-3.5 py-1 rounded-xl flex items-center gap-2 backdrop-blur-sm scale-90 sm:scale-95">
          {currentEffect.type === 'bang' && (
            <>
              ...
              <div className="text-right">
                ...
                <span className="text-zinc-300 text-[11px] sm:text-xs font-bold mx-1">
                  به سمت
                </span>
                <span className="text-red-400 font-black text-xs sm:text-sm">
                  {currentEffect.targetPlayerName || 'هدف'}
                </span>
                <span className="text-amber-300 font-bold text-[11px] sm:text-xs mr-1">
                  شلیک کرد! (بنگ!)
                </span>
              </div>
            </>
          ...
          {currentEffect.type === 'jail' && (
            <>
              ...
              <div className="text-right">
                ...
                <span className="text-blue-300 font-black text-xs sm:text-sm">
          ...
          {currentEffect.type === 'saloon' && (
            <>
              ...
              <div className="text-right">
                ...
                <span className="text-emerald-300 font-bold text-[11px] sm:text-xs mr-1">
          ...
          {currentEffect.type === 'stagecoach' && (
            <>
              ...
              <div className="text-right">
                ...
                <span className="text-amber-200 font-bold text-[11px] sm:text-xs mr-1">
          ...
          {currentEffect.type === 'missed' && (
            <>
              ...
              <div className="text-right">
                <span className="text-sky-300 font-black text-xs sm:text-sm">
                  {currentEffect.sourcePlayerName || 'بازیکن'}
                </span>
                <span className="text-zinc-300 text-[11px] sm:text-xs font-bold mr-1">
          ...
          {currentEffect.type === 'beer' && (
            <>
              ...
              <div className="text-right">
                ...
                <span className="text-emerald-300 text-[11px] sm:text-xs font-bold mr-1">
          ...
          {currentEffect.type === 'gatling' && (
            <>
              ...
              <div className="text-right">
                ...
                <span className="text-red-400 text-[11px] sm:text-xs font-bold mr-1">
          ...
          {currentEffect.type === 'indians' && (
            <>
              ...
              <div className="text-right">
                ...
                <span className="text-orange-400 text-[11px] sm:text-xs font-bold mr-1">
          ...
          {currentEffect.type === 'duel' && (
            <>
              ...
              <div className="text-right">
                ...
                <span className="text-zinc-300 text-[11px] sm:text-xs mr-1">
          ...
          {currentEffect.type === 'dynamite_explode' && (
            <>
              ...
              <div className="text-right">
                ...
                <span className="text-amber-300 text-[11px] sm:text-xs mr-1">
                  ۳ جان از دست رفت!
                </span>
              </div>
            </>
          ...
          {currentEffect.type === 'cat_balou' && (
            <>
              <span className="text-lg sm:text-xl">🔥</span>
              <div className="text-right">
                <span className="text-orange-400 font-black text-xs sm:text-sm">
                  کارت کت بالو!
                </span>
                <span className="text-zinc-300 text-[11px] sm:text-xs mr-1">
      ...
      {/* 2. Visual Center Animations - Scaled down for refined, non-intrusive elegance */}
      <div className="relative w-full h-full flex items-center justify-center pointer-events-none select-none scale-70 sm:scale-75 origin-center transition-transform">
        ...
        {currentEffect.type === 'bang' && (
          <div className="relative w-full h-full flex items-center justify-center pointer-events-none">
            ...
            <div
              className="relative flex items-center justify-center -translate-x-12 sm:-translate-x-16"
              style={{
                animation: 'westernGunRecoil 1.2s cubic-bezier(0.25, 1, 0.5, 1) forwards',
            ...
            >
              ...
              <div
                className="absolute top-10 left-24 pointer-events-none"
                style={{ animation: 'bulletShellEject 1.2s ease-out forwards' }}
              >
                <div className="w-2 h-3.5 bg-gradient-to-b from-amber-300 to-amber-600 rounded-sm border border-amber-700 shadow" />
              </div>

              {/* Gunsmoke Billow Puff */}
              <div className="absolute top-6 right-2 flex gap-1 pointer-events-none opacity-80">
                <div className="w-6 h-6 rounded-full bg-zinc-300/40 blur-sm animate-ping" />
                <div className="w-8 h-8 rounded-full bg-zinc-400/30 blur-md animate-pulse" />
              </div>
            </div>
            ...
            <div
              ...
              style={{
                animation: 'bulletFlyAcross 1.2s cubic-bezier(0.1, 0.7, 0.1, 1) forwards',
              }}
            >
              <div className="relative flex items-center">
                {/* Detailed 3D Brass Bullet with Speed Trail */}
                <svg className="w-12 h-6 sm:w-16 sm:h-7" viewBox="0 0 65 24" fill="none">
                  <defs>
            ...
            <div
              className="absolute right-6 sm:right-12 top-1/2 -translate-y-4 pointer-events-none"
              style={{ animation: 'impactHitSpark 1.2s ease-out forwards' }}
            >
              <div className="relative flex items-center justify-center">
                <div className="w-6 h-6 rounded-full bg-saloon-950 border-2 border-stone-700 flex items-center justify-center">
        ...
        {currentEffect.type === 'jail' && (
          <div className="relative w-full h-full flex items-center justify-center pointer-events-none select-none">
            ...
            <div
              ...
              style={{ animation: 'jailBarsDrop 1.2s cubic-bezier(0.175, 0.885, 0.32, 1.275) forwards' }}
            >
              {/* The Prison Bars SVG */}
              <svg
              ...
              <div
                ...
                style={{ animation: 'padlockSnap 1.2s ease-out forwards' }}
              >
                <div className="relative flex flex-col items-center">
                  <svg className="w-20 h-24 sm:w-24 sm:h-28" viewBox="0 0 120 140" fill="none">
                  ...
                  {/* Prison Label */}
                  <div className="mt-[-6px] bg-red-950/95 border border-red-500 text-red-200 px-3 py-0.5 rounded-lg shadow-lg font-black text-[11px] tracking-wider animate-pulse flex items-center gap-1">
                    <span>🔒</span>
                    <span>هلفدونی</span>
                  </div>
                </div>
        ...
        {currentEffect.type === 'stagecoach' && (
          <div className="relative w-full h-full flex items-center justify-center pointer-events-none select-none">
            <div
              ...
              style={{ animation: 'stagecoachRoll 1.2s ease-in-out forwards' }}
            >
              <svg className="w-40 h-28 sm:w-52 sm:h-36" viewBox="0 0 340 200" fill="none">
                ...
                <g className="animate-spin" style={{ transformOrigin: '115px 145px', animationDuration: '0.5s' }}>
                ...
                <g className="animate-spin" style={{ transformOrigin: '215px 145px', animationDuration: '0.5s' }}>
                ...
                <text x="10" y="125" fontSize="40" fill="#000000">🐎</text>
              </svg>
            </div>
          </div>
        )}
        ...
        {currentEffect.type === 'saloon' && (
          <div className="relative w-full h-full flex flex-col items-center justify-center pointer-events-none select-none animate-in zoom-in-75 duration-150">
            <div className="flex items-center gap-4">
              <span className="text-3xl sm:text-4xl animate-bounce" style={{ animationDelay: '0s' }}>🍺</span>
              <span className="text-4xl sm:text-5xl animate-bounce" style={{ animationDelay: '0.15s' }}>🍻</span>
              <span className="text-3xl sm:text-4xl animate-bounce" style={{ animationDelay: '0.3s' }}>🍺</span>
            </div>
            <div className="mt-2 bg-gradient-to-r from-amber-600 via-yellow-500 to-amber-600 text-saloon-950 font-black text-xs sm:text-sm px-3.5 py-1 rounded-xl border border-amber-300 shadow-lg animate-pulse">
              یک دور نوشیدنی در سالون به حساب حاکم! (+۱ جان)
            </div>
          </div>
        )}
        ...
        {currentEffect.type === 'general_store' && (
          <div className="relative w-full h-full flex flex-col items-center justify-center pointer-events-none select-none animate-in zoom-in-75 duration-150">
            <div className="relative flex items-center justify-center">
              ...
              <div className="absolute -bottom-1 -left-2 text-lg animate-bounce" style={{ animationDelay: '0.2s' }}>🃏</div>
            </div>
            <div className="mt-2 bg-gradient-to-r from-emerald-600 via-teal-500 to-emerald-600 text-white font-black text-[11px] sm:text-xs px-3.5 py-1 rounded-xl border border-emerald-300 shadow-lg animate-pulse">
              فروشگاه باز شد — کارت‌ها روی میز چیده شدند!
            </div>
          </div>
        )}
        ...
        {currentEffect.type === 'missed' && (
          <div className="relative flex flex-col items-center justify-center animate-in zoom-in-75 duration-150">
            <div className="relative">
              ...
              <div className="absolute top-1 right-0 text-xl animate-ping">✨</div>
              <div className="absolute bottom-1 left-0 text-base animate-ping duration-300">💥</div>
            </div>
            <span className="mt-2 bg-gradient-to-r from-sky-500 via-blue-600 to-sky-500 text-white font-black text-sm sm:text-lg px-4 py-1 rounded-xl shadow-lg border border-sky-300 animate-bounce">
              زپلشک! (Missed!)
            </span>
          </div>
        )}
        ...
        {currentEffect.type === 'beer' && (
          <div className="relative flex flex-col items-center justify-center animate-in zoom-in-75 duration-150">
            <div className="relative">
              ...
              <span className="absolute -top-4 left-1 text-base animate-pulse">✨</span>
            </div>
            <span className="mt-2 bg-gradient-to-r from-emerald-600 via-green-500 to-emerald-600 text-white font-black text-sm sm:text-lg px-4 py-1 rounded-xl shadow-lg border border-emerald-300 animate-bounce">
              +۱ جان (نوشیدنی)
            </span>
          </div>
        )}
        ...
        {currentEffect.type === 'gatling' && (
          <div className="relative flex flex-col items-center justify-center animate-in zoom-in-75 duration-150">
            ...
            <span className="mt-2 bg-gradient-to-r from-red-600 via-amber-600 to-red-600 text-white font-black text-sm sm:text-lg px-4 py-1 rounded-xl shadow-lg border border-amber-400 animate-pulse">
              رگبار مسلسل گاتلینگ!
            </span>
          </div>
        )}
        ...
        {currentEffect.type === 'duel' && (
          <div className="relative flex flex-col items-center justify-center animate-in zoom-in-75 duration-150">
            <div className="flex items-center gap-2.5">
              <span className="text-4xl sm:text-5xl transform rotate-45 animate-pulse">🔫</span>
              <span className="text-3xl sm:text-4xl text-amber-400 animate-ping">⚡</span>
              <span className="text-4xl sm:text-5xl transform -rotate-45 scale-x-[-1] animate-pulse">🔫</span>
            </div>
            <span className="mt-2 bg-gradient-to-r from-purple-600 via-indigo-600 to-purple-600 text-white font-black text-sm sm:text-lg px-4 py-1 rounded-xl shadow-lg border border-purple-300 animate-pulse">
              دوئل تن به تن!
            </span>
          </div>
        )}
        ...
        {currentEffect.type === 'dynamite_explode' && (
          <div className="relative flex flex-col items-center justify-center animate-in zoom-in-75 duration-100">
            ...
            <span className="mt-2 bg-gradient-to-r from-red-600 via-rose-700 to-red-600 text-white font-black text-base sm:text-xl px-5 py-1.5 rounded-xl shadow-lg border border-red-400 animate-bounce">
        ...
        {currentEffect.type === 'barrel_success' && (
          <div className="relative flex flex-col items-center justify-center animate-in zoom-in-75 duration-150">
            <div className="relative">
              <span className="text-5xl sm:text-6xl">🛢️</span>
              <span className="absolute -top-2 -right-1 text-xl animate-bounce">❤️</span>
              <span className="absolute -bottom-1 -left-1 text-2xl text-emerald-400 font-black animate-pulse">✓</span>
            </div>
            <span className="mt-2 bg-gradient-to-r from-amber-700 via-yellow-600 to-amber-700 text-white font-black text-sm sm:text-lg px-4 py-1 rounded-xl shadow-lg border border-amber-300 animate-bounce">
              بشکه نجات داد! (کارت دل ♥)
            </span>
          </div>
        )}
        ...
        {currentEffect.type === 'cat_balou' && (
          <div className="relative flex flex-col items-center justify-center animate-in zoom-in-75 duration-150">
            <div className="relative flex items-center justify-center">
              <span className="text-4xl sm:text-5xl animate-pulse">🃏</span>
              <span className="absolute text-5xl sm:text-6xl animate-bounce">🔥</span>
            </div>
            <span className="mt-2 bg-gradient-to-r from-orange-600 via-red-600 to-orange-600 text-white font-black text-sm sm:text-lg px-4 py-1 rounded-xl shadow-lg border border-orange-300 animate-bounce">
              کارت سوخت! (کت بالو)
            </span>
          </div>
        )}
        ...
        {currentEffect.type === 'panic' && (
          <div className="relative flex flex-col items-center justify-center animate-in zoom-in-75 duration-150">
            ...
            <span className="mt-2 bg-gradient-to-r from-amber-600 via-yellow-500 to-amber-600 text-saloon-950 font-black text-sm sm:text-lg px-4 py-1 rounded-xl shadow-lg border border-amber-300 animate-bounce">
              دستبرد سریع! (تهدید)
            </span>
          </div>
        )}
